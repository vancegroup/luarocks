...
function(luarocks_install _target _rock _rockstree)
	...
	if(TARGET ${LUA_LIBRARY})
		set(LUAROCKS_BUILDTREE_LUA_LIBDIR "$<TARGET_LINKER_FILE_DIR:${LUA_LIBRARY}>")
		set(LUALIB "$<TARGET_LINKER_FILE_NAME:${LUA_LIBRARY}>")
		if(WIN32)
			list(APPEND
				LUAROCKS_BUILDTREE_EXTRAPATH
				"$<TARGET_FILE_DIR:${LUA_LIBRARY}>")
		endif()
	else()
